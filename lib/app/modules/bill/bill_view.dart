                ...
                return Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            color: bill.status == 'aberto' ? Colors.green.shade100 : Colors.red.shade100,
                            elevation: 2,
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text('VALOR APROVADO: ${FormattedInputers.formatValue(bill.valorAprovado.toString())}'.toUpperCase()),
